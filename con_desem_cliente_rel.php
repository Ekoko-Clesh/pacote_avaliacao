<?php
    ...
    $lista_de_clientes = Funcoes::Clientes();
    session_start();
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="d-flex justify-content-center mt-4 mb-1">
        <form action="con_desempenho.php" method="POST">
            <button type="submit" class="btn btn-primary m-3" name="cliente">Por Consultor</button>
        </form> 
    ...
    <h3 class="text-center fs-1 text-primary">Filtrar clientes</h3>
...
<form action="get_solicitacao.php" method="POST">
    ...
    <div class="d-flex mt-1 mb-1 justify-content-center">
        <select name="list1" id="list1" class="form-select w-25 m-3" multiple aria-label="multiple select example">
                 <?php if ($lista_de_clientes->num_rows > 0) {
                        while($row = $lista_de_clientes->fetch_assoc()) {?>
                            <option value=<?php echo $row["no_fantasia"]?>><?php echo $row["no_fantasia"]?></option>
                        <?php
                        }?>
                    <?php
                  }?>
    ...
    <div class="d-flex mt-4 mb-2 justify-content-center">
        ...
        <!-- INDICA QUE É ABA DE CLIENTE -->
        <input type="hidden" name="funcao" value="cliente">
    </div>
</form>

    <div class="w-100 mt-4">
    <?php 
            //RECUPERAR clientes ARMAZENADOS NA SESSAO
   ...
   <table id="example" class="table table-hover table-striped table-bordered w-100 table-bordered table-responsive-sm">            
                ...
                <thead>
                        <tr>
                            ...
                            <?php
                                ...
                                <th scope="col"><?php echo $cliente?></th>
                                <?php
                            }
                            ?>
                ...
                <?php
            }else{echo "<h3 class='text-center'><span class='badge bg-primary'>Seleccione os clientes para gerar Relatório</span></h3>";}?>
    </div>
